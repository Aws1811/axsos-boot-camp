...
class Message(models.Model):
    user = models.ForeignKey(Login,related_name="mess",on_delete=models.CASCADE)
...
class Comment(models.Model):
    user = models.ForeignKey(Login,related_name="comments",on_delete=models.CASCADE)
    mess = models.ForeignKey(Message,related_name="comments",on_delete=models.CASCADE)
    commet = models.TextField(null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
