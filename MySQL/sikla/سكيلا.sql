...
select customer.first_name , customer.last_name , email , address , address.city_id
from customer
join address
...
where store_id = 1 and city_id = 1 or 42 or 312 or 459;
...
join category
on category.category_id = film_category.category_id
where category.name = "drama" and film.rating > 2.99 ;
